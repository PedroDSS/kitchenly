      ...
      <div class="py-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <p class="text-sm text-gray-400 mb-6">
            Votre spécialiste en électroménager pour votre maison connectée.
          </p>
          <div class="space-y-2 text-sm text-gray-400">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span>contact.kitchenly@gmail.com</span>
            </div>
            <div class="flex items-center space-x-2">
        ...
        <div>
          ...
          <div class="flex space-x-3 mb-6">
              ...
              <a href="https://x.com/" target="_blank" class="social-link" aria-label="X (anciennement Twitter)">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.53 2H21l-7.19 8.19L22.66 22h-7.78l-5.06-6.31L3.8 22H0l7.84-8.93L1.34 2h7.91l4.47 5.57L17.53 2zm-2.23 18h2.09L8.66 4H6.52l8.78 16z"/>
                </svg>
              </a>
