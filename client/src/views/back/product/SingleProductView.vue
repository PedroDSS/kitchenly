                ...
                <SheetContent>
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      ...
                      <p>
                        Tous les produits vendus sur Kitchenly sont sélectionnés avec soin auprès de partenaires de confiance. Chaque appareil est contrôlé pour garantir son bon fonctionnement, sa propreté irréprochable et sa conformité à nos standards de qualité. Tous nos produits sont couverts par une garantie.
                      </p>
                      <ul class="mt-4">
                        <li
                          v-for="(
